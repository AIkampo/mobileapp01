...
class p02View extends StatefulWidget {
  final int type;
  final String url;

  const p02View({Key key, this.type, this.url}) : super(key: key);

  @override
  _p02ViewState createState() => new _p02ViewState();
}

class _p02ViewState extends StateMVC<p02View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p02View:";
  p02Model _model;
