...
class p09View extends StatefulWidget {
  ...
  const p09View({Key key, this.type, this.url}) : super(key: key);

  @override
  _p09ViewState createState() => new _p09ViewState();
}

class _p09ViewState extends StateMVC<p09View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p09View:";
  p02Model _model;
