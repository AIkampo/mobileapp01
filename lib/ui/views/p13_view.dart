...
class p13View extends StatefulWidget {
  ...
  const p13View({Key key, this.type, this.url}) : super(key: key);

  @override
  _p13ViewState createState() => new _p13ViewState();
}

class _p13ViewState extends StateMVC<p13View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p13View:";
  p02Model _model;
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          ...
                          _model.navigationService.popAndPush(routes.p05ViewRoute,);
                        },
                        child: Align(
                          alignment: Alignment.center,
                          child: Container(
