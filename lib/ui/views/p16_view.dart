...
class p16View extends StatefulWidget {
  ...
  const p16View({Key key, this.type, this.url}) : super(key: key);

  @override
  _p16ViewState createState() => new _p16ViewState();
}

class _p16ViewState extends StateMVC<p16View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p16View:";
  p02Model _model;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AutoSizeText(
                          _model.keyString2("verify_done"),
                          style: TextStyle(fontSize: 18.sp, color: Colors.black, fontWeight: FontWeight.normal, fontFamily: _model.getFontFamily(), letterSpacing: 2.2),
                      ...
                      GestureDetector(
                        onTap: (){
                          ...
                          _model.navigationService.popToRootAndReplace(routes.p18ViewRoute,);
                        },
                        child: Container(
                          height: 40.h,
                          width: 360.w,
