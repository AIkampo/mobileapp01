...
class p22View extends StatefulWidget {
  final int type;
  final String url;

  const p22View({Key key, this.type, this.url}) : super(key: key);

  @override
  _p22ViewState createState() => new _p22ViewState();
}

class _p22ViewState extends StateMVC<p22View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p22View:";
  p02Model _model;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AutoSizeText(
                          _model.keyString2("registration_ok"),
