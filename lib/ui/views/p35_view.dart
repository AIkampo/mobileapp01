...
class p35View extends StatefulWidget {
  ...
  const p35View({Key key, this.score, this.json}) : super(key: key);

  @override
  _p35ViewState createState() => new _p35ViewState();
}

class _p35ViewState extends StateMVC<p35View> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  final TAG = "p35View:";
  p35Model _model;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    height: 42.h,
                                    child: AutoSizeText(
                                      _model.scores9[0].toString() + _model.keyString2('points'),
